...
//     courseBlock.innerHTML = `<h3>${course.title}</h3><p>Duration: ${course.monthDuration} months</p>`;
//     contain.appendChild(courseBlock);
// });
